...
;
 ...
 LOW_ISR
    ...
    MOVWF LATC ; PORTA => 4 premi�res LEDs, PORTC => 4 derni�res LEDs
    
    COMF LEDs, 1 ; Inversion de l'output, puis mise du r�sultat dans l'output
    
    ; Ecriture du compteur � 3035
...
MAIN
	...
	; 0 : mode Sleep lors de l'instruction SLEEP (inutilis�)
	; 101 : fr�quence de 4MHz (1M instructions / s)
    ...
    MOVF TRISC ; 4 bits de poids fort � 0 => acc�s aux 4 leds
    ...
    MOVLW b'01010101' ; Output � �crire sur les ports
    MOVWF LEDs
